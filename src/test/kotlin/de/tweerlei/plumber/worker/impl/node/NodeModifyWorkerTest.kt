...
class NodeModifyWorkerTest {
    ...
    fun testSet() {
        ...
        item.get(WellKnownKeys.NODE).toString().shouldBe("""{"entry":"value"}""")
    }
    ...
    fun testSetNull() {
        ...
        item.shouldNotBeNull()
        item.get(WellKnownKeys.NODE).toString().shouldBe("""{"entry":null}""")
    }
    ...
    fun testObject() {
        ...
        item.shouldNotBeNull()
        item.get(WellKnownKeys.NODE).toString().shouldBe("""{"values":{"entry":"value"}}""")
    }
