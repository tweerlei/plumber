...
class RootWorkerTest {

    @Test
    fun testDouble() {
        test(DoubleValue.of(1000.0), DoubleValue.of(3.0), DoubleValue.of(10.0))
        test(DoubleValue.of(64.0), DoubleValue.of(2.0), DoubleValue.of(8.0))
    }
