...
class PowerWorkerTest {

    @Test
    fun testDouble() {
        test(DoubleValue.of(10.0), DoubleValue.of(2.0), DoubleValue.of(100.0))
        test(DoubleValue.of(64.0), DoubleValue.of(0.5), DoubleValue.of(8.0))
    }
