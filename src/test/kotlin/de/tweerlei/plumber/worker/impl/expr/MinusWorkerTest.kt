...
class MinusWorkerTest {
    ...
    @Test
    fun testDouble() {
        test(DoubleValue(0.12), DoubleValue(0.23), DoubleValue(-0.11))
        test(DoubleValue(0.12), DoubleValue(1001.23), DoubleValue(-1001.11))
        test(DoubleValue(1001.12), DoubleValue(0.23), DoubleValue(1000.89))
    ...
    fun testMixed() {
        ...
        test(DoubleValue(0.12), LongValue(1001L), DoubleValue(-1000.88))
        test(LongValue(1001L), DoubleValue(0.23), DoubleValue(1000.77))
