...
class SNSClientFactory(
    ...
    @Value("\${aws.sns.endpoint}") private val awsEndpoint: String,
    private val stsService: AWSSecurityTokenService
) {

    fun createAmazonSNSClient(numberOfThreads: Int, roleArn: String?): AmazonSNS =
        AmazonSNSClientBuilder.standard().apply {
